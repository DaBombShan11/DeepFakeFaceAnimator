   ...
   if (currentImageIndex >= totalQuestions) {
       if (correctAnswers < 4) {
           ...
           resultContainer.innerHTML = `
               ...
               <button onclick="window.location.href='.../congratulations.html'">Click to obtain certificate</button>
           `;
       }
...
function restartQuiz() {
   currentImageIndex = 0;
   wrongAnswersCount = 0;
   resultContainer.innerHTML = ''; // Clear result message and buttons
   showNextImage(); // Restart the quiz by showing the first image
}
